...
; A program that calculates the change in pirce for every change in price of 0.2 dollars
;This function mult. by -.2 in order for the price and pop variables to have properly oorresponding affects on each other in the next
;level of abstraction in this calculator 
(define (deviation-price y) (+ 5 (* -.2 y)))

(deviation-price -2) ;raise price 
(deviation-price 2) ;lower price 
